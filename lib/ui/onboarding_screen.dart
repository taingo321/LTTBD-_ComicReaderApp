...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 77, 75, 207),
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: Color.fromARGB(255, 134, 134, 216),
        actions: [
          Padding(
            ...
            child: InkWell(
              ...
              child: const Text(
                'Skip',
                style: TextStyle(
                  color: Color.fromARGB(255, 226, 163, 16),
                  fontSize: 16.0,
            ...
            child: Container(
              child: IconButton(
                  ...
                  icon: const Icon(
                    ...
                    size: 24,
                    color: Color.fromARGB(255, 240, 17, 17),
                  )),
